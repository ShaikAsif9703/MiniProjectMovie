...
public class MovieDetailsPages {
    ...
    By loginButtonInputLocator = By.className("login-button");
    ...
    public void loginButton(){
        driver.findElement(loginButtonInputLocator).click();
    }
